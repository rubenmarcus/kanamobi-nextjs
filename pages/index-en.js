        ...
        return (
            ...
            <Layout>
                ...
                <QuemSomos gallery={this.props.QuemSomosGallery} quemsomos={this.props.QuemSomos} lang={this.state.portuguese} />
                 ...
                 <LazyLoad height={1200}>
                <EcoSistema info={this.props.Ecossistema} Ecoin={this.props.EcossistemaIn} lang={this.state.portuguese}   />
                </LazyLoad>
                <LazyLoad height={1200}>
                <Cases stories={this.props.Cases} destaque={this.props.CasesDest} info={this.props.Success}  lang={this.state.portuguese}  />
                </LazyLoad>
                <LazyLoad height={1200}>
...
export default PageWrapper(IndexEn);
